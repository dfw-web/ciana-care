...
export const SERVICE_GROUPS: ServiceGroup[] = [
  {
    ...
    description: "Comprehensive medical laboratory tests including blood work, microbiology, hematology, and more.",
    categories: [
      {
  ...
  {
    group: "Ultrasound Services",
    description: "Comprehensive ultrasound and scan services performed by experienced sonographers.",
    categories: [
      {
        category: "ULTRASOUND SCANS",
        tests: [
          { name: "Abdominal Scan", price: 8000 },
          { name: "Pelvic Scan", price: 8000 },
          { name: "Abdomino-Pelvic Scan", price: 10000 },
          { name: "Transvaginal Scan", price: 18000 },
          { name: "Transrectal Scan", price: 20000 },
          { name: "Breast Scan", price: 18000 },
          { name: "Scrotal Scan", price: 18000 },
          { name: "Obstetrics Scan", price: 8000 },
        ],
      },
    ],
  },
  {
    group: "Clinic Partnerships",
    description: "We collaborate with clinics and hospitals to provide reliable diagnostic support. Partner with us for seamless laboratory services for your patients.",
    categories: [],
  },
  {
    group: "School Admission Screening",
    description: "Comprehensive medical screening packages for students. Includes health assessments required for school admission and enrollment.",
    categories: [],
  },
  {
    group: "Employment Screening",
    description: "Pre-employment medical checks and health assessments. Ensure your workforce meets health and safety requirements.",
    categories: [],
  },
];

// Backwards compatible
export const TEST_CATALOG: TestCategory[] = SERVICE_GROUPS.flatMap(g => g.categories);
